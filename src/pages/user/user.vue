<template>
  <view class="container">
    ...
    <view v-if="isAdmin" class="menu-section">
      <view class="menu-item" @click="goToBehaviorAnalytics">
        <text class="menu-icon">📊</text>
        <text class="menu-text">用户行为分析</text>
        <text class="menu-arrow">></text>
      </view>
    </view>
...
export default {
  ...
  methods: {
    ...
    goToBehaviorAnalytics() {
      ...
      uni.navigateTo({
        url: '/pages/user/behavior-analytics'
      })
    },
